...
public class AlgeriaSupscriptionPage extends PageBase{
    @FindBy(id = "dz-contry-flag")
    WebElement Algeria_country_flag;
    ...
    public AlgeriaSupscriptionPage(WebDriver driver) {
        super(driver);
    }
    public void Select_country_Algeria(){
        clickButton(Algeria_country_flag);
    }
